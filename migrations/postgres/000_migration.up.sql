...
CREATE INDEX IF NOT EXISTS idx_message_deleted_user_id ON message_deleted (user_id);
CREATE INDEX IF NOT EXISTS idx_message_read_user_peer ON message_read (user_id, peer_id);
